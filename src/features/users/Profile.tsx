                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-4 hidden lg:table-cell">
                                            {solvedExerciseIds.has(solution.exerciseId) ? (
                                                <code className="px-2 py-1 bg-green-500/10 text-green-400 rounded text-sm font-mono">
                                                    {solution.correctAnswer.length > 30
                                                        ? solution.correctAnswer.substring(0, 30) + "..."
                                                        : solution.correctAnswer}
                                                </code>
                                            ) : (
                                                <span className="text-text/30 italic text-xs">Доступно после верного решения</span>
                                            )}
                                        </td>
                                        <td className="px-4 py-4 hidden lg:table-cell">
